...
def main():
    ...
    #     .addGrid(svm_clf.maxIter, [10, 50])
    #     .build()
    # )
    # Test Grid
    param_grid = (
        ParamGridBuilder()
        .addGrid(chi_square_selector.numTopFeatures, [300])
        .addGrid(svm_clf.regParam, [0.1])
        .addGrid(svm_clf.standardization, [False])
        .addGrid(svm_clf.maxIter, [10])
        .build()
    )
    ...
    # Build the output report lines.
    result_lines = [
        "Assignment 2 Part 3 - SVM classification results",
