...
def main():
    ...
    # Read reviews and ensure text is present.
    reviews_df = (
    ...
    # The pipeline chains all the transformations together. When fit() is called, it executes each stage in order, allowing us to extract the final selected features.
